...
def main(ARGS):
    ...
    for frame in frames:
        if frame is not None:
            ...
            with open("/Users/egor.nakonechnyyicloud.com/PycharmProjects/MEETKEYmain/appcoverage/checkword.txt", "r") as file:
                cont = file.read()
            if cont in text and cont != 'Nothing223':
...
if __name__ == '__main__':
    ...
    ARGS = dict()
    # print(type(ARGS))
    ARGS['vad_aggressiveness'] = 3
    ARGS['model'] = '/Users/egor.nakonechnyyicloud.com/PycharmProjects/deepspeech-0.9.3-models.pbmm'
    ARGS['scorer'] = '/Users/egor.nakonechnyyicloud.com/PycharmProjects/deepspeech-0.9.3-models.scorer'
    ARGS['savewav'] = None
    ARGS['nospinner'] = None
    ARGS['file'] = None
    ARGS['device'] = indx
